#ifndef KNX_TEMPERATURE_INCLUDE_SERIALREADINGDELEGATEDEMO_H_
#define KNX_TEMPERATURE_INCLUDE_SERIALREADINGDELEGATEDEMO_H_
...
#endif /* KNX_TEMPERATURE_INCLUDE_SERIALREADINGDELEGATEDEMO_H_ */
